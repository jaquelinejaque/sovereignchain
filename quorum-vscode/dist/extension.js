"use strict";var L=Object.create;var f=Object.defineProperty;var B=Object.getOwnPropertyDescriptor;var K=Object.getOwnPropertyNames;var M=Object.getPrototypeOf,D=Object.prototype.hasOwnProperty;var U=(t,e)=>{for(var o in e)f(t,o,{get:e[o],enumerable:!0})},Q=(t,e,o,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of K(e))!D.call(t,s)&&s!==o&&f(t,s,{get:()=>e[s],enumerable:!(n=B(e,s))||n.enumerable});return t};var v=(t,e,o)=>(o=t!=null?L(M(t)):{},Q(e||!t||!t.__esModule?f(o,"default",{value:t,enumerable:!0}):o,t)),W=t=>Q(f({},"__esModule",{value:!0}),t);var ce={};U(ce,{activate:()=>re,deactivate:()=>ie});module.exports=W(ce);var d=v(require("vscode"));var r=v(require("vscode")),l;function R(t,e,o){return r.commands.registerCommand("quorum.ask",async()=>{if(!await G())return;let n=await r.window.showInputBox({prompt:"Ask Quorum...",placeHolder:'e.g. "What is the safest way to store an API key in a VS Code extension?"',ignoreFocusOut:!0});n&&await p(t,e,n,"Quorum: Ask",o)})}function E(t,e,o){return r.commands.registerCommand("quorum.askAboutSelection",async()=>{let n=y("Quorum: highlight some code first.");if(!n)return;let s=await r.window.showInputBox({prompt:"What about this code?",ignoreFocusOut:!0});if(!s)return;let c=`\`\`\`${n.language}
${n.code}
\`\`\`

${s}`;await p(t,e,c,"Quorum: Ask about selection",o)})}function A(t,e,o){return r.commands.registerCommand("quorum.explainSelection",async()=>{let n=y("Quorum: highlight code to explain.");if(!n)return;let s=`Explain the following ${n.language} code in 3-5 sentences. What does it do? What are the edge cases?
